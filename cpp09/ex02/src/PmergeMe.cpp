...
/*   Updated: 2025/11/25 21:40:41 by vtrofyme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void PmergeMe::mergeSort(std::vector<int>& v) {
    ...
    for (size_t i = 0; i < mid; ++i) left.push_back(v[i]);
    for (size_t i = mid; i < v.size(); ++i) right.push_back(v[i]);
